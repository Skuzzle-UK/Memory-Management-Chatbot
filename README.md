C++ coursework
I have added to the readme at task 4 just to make you guys aware of a small typo.
Also during the coursework I have noticed that one of the required changes was outside of the ////Student code section in graphnode.h
...
### Task 1 : Exclusive Ownership 1 - COMPLETE
In file `chatgui.h` / `chatgui.cpp`, make `_chatLogic` an exclusive resource to class `ChatbotPanelDialog` using an appropriate smart pointer. Where required, make changes to the code such that data structures and function parameters reflect the new structure. 

### Task 2 : The Rule Of Five - COMPLETE
...
### Task 3 : Exclusive Ownership 2 - COMPLETE
...
### Task 4 : Moving Smart Pointers - COMPLETE

***should read `graphnode.h` and `graphnode.cpp` (current has s added to the end of both file names)
...
### Task 5 : Moving the ChatBot - COMPLETE
